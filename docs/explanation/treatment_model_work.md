...
8. Add the system-membership query for "everything involved in an objective" to `docs/guides/querying_treatment_function.md`, and fix that file's variable names, which contain a space (`?treatment objective`) after an earlier rename. Described in section 9.
