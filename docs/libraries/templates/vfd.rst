...
.. tabs::
    ...
    .. tab:: With Inline Dependencies
        ...
        .. code:: turtle
            ...
            P:name a <https://watermetadata.org/ontology/watr#VariableFrequencyDrive> ;
                ns1:hasConnectionPoint P:in,
                    P:out ;
                ns1:hasRole P:role .
