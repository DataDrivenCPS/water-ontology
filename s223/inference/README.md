This folder contains SHACL rules files for the schema, models and/or data. These define things like inferred properties using sh:values in propertyShapes.
